...
static void BSHD_FP16_GQA_PREFILL(benchmark::State& state) {
...
static void BSHD_FP16_GQA_DECODE(benchmark::State& state) {
  int32_t S_QKV = static_cast<int32_t>(state.range(0));
...
BENCHMARK(BSHD_FP16_GQA_PREFILL)->RangeMultiplier(2)->Range(32, 2048);
BENCHMARK(BSHD_FP16_GQA_DECODE)->RangeMultiplier(2)->Range(32, 2048);
BENCHMARK_MAIN();
